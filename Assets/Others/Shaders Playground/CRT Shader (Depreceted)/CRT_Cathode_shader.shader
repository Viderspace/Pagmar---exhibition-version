Shader "Hidden/CRT_Cathode_shader"
 {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 fp(v2f i) : SV_Target {
                ...
                col.g *= (sin(i.uv.y * _ScreenParams.y * 2.0f) + 1.0f) * _green_offset + 1.0f;
                col.rb *= (cos(i.uv.y * _ScreenParams.y * 2.0f) + 1.0f) * _red_blue_offset + 1.0f; 
